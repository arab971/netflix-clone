...
const SearchPage = () => {
	...
	const handleSearch = async (e) => {
		e.preventDefault();
		try {
			const res = await axios.get(`http://localhost:3000/api/v1/search/${activeTab}/${searchTerm}`);
